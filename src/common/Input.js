...
export default function Input(props) {
  ...
  return (
    ...
    <div className='d-flex flex-column'>
      ...
      <i style={{ fontSize: "20px", top: "12px", right: "10px", position: "absolute" }}
        // eslint-disable-next-line
        onClick={(event) => ((props.iconRight === "fa-solid fa-eye" ? hidepassword : props.iconRight === "fa-solid fa-copy" ? () => copyInputValue(props.id) : null)(event), event.stopPropagation())} className={props.iconRight === "fa-solid fa-eye" ? (eyeInstance ? props.iconRightAlter : props.iconRight) : props.iconRight}></i>
      </div>
    </div>
    </>
  )
